...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form class="form-horizontal" action="achat.php" method="post">
                <fieldset>
            ...
            <form class="form-horizontal" action="ajouter-panier-client.php" method="post" onsubmit="return validate(this)">
                <fieldset>
