<?php
    ...
    {
        $req=$bdd->prepare('UPDATE client SET nom=:nom,prenom=:prenom,adresse=:adresse,telephone=:telephone,email=:email WHERE codCli=:codCli') or die(print_r($bbd->errorInfo()));
        $req->execute(array(
