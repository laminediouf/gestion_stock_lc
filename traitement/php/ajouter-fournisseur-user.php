<?php
    ...
    {
        $req=$bdd->prepare('INSERT INTO fournisseur (nom,prenom,adresse,telephone,email) VALUES(:nom,:prenom,:adresse,:telephone,:email)') or die(print_r($bbd->errorInfo()));
        $req->execute(array(
            'nom'=>$_POST['nom'],
            'prenom'=>$_POST['prenom'],
        ...
        echo '<script>alert("Le fournisseur a bien ete ajoute dans la base de donnees")</script>';
    }
?>
<!DOCTYPE HTML>
<html>
    ...
    <body>
        <div class="container">
            ...
            <form class="form-horizontal" action="ajouter-fournisseur.php" method="post" onsubmit="return validate(this)">
                <fieldset>
                    <h2 class="titre">Ajout fournisseur :</h2>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 control-label">
                            <input type="submit" value="Ajouter fournisseur" class="btn btn-info btn-block">
                        </div>
                    </div>
                </fieldset>
            </form>
        </div>
        <script src="../js/validate_form_fournisseur.js"></script>
